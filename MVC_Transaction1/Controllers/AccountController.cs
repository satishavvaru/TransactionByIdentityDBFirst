...
namespace MVC_Transaction1.Controllers
{
    [Authorize]
    public class AccountController : Controller
    {
        ...
        public AccountController(UserManager<MyUser, long> userManager, RoleManager<MyRole, long> roleManager)
        {
        ...
        public RoleManager<MyRole, long> RoleManager { get; private set; }
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> RegisterRoles(RegisterRolesViewModel model)
        {
            if (ModelState.IsValid)
            {
                var role = new MyRole() { Name = model.Name };
                //                'PasswordHash'.
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new MyUser() { UserName = model.UserName, Email = model.Email, PhoneNumber = model.PhoneNumber };
                //                'PasswordHash'.
                //Invalid column name 'PhoneNumber'.
                //Invalid column name 'PhoneNumberConfirmed'.
                //Invalid column name 'TwoFactorEnabled'.
